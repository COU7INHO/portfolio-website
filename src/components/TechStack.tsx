...
const TechStack = () => {
  ...
  const getMobileData = (): Record<string, { 
    ...
    'Languages & Frameworks': {
      stars: [
        { id: 'python', name: 'Python', x: 0.15, y: 0.06 },
        { id: 'django', name: 'Django', x: 0.08, y: 0.14 },
        { id: 'drf', name: 'Django REST Framework', x: 0.22, y: 0.14 },
        { id: 'fastapi', name: 'FastAPI', x: 0.15, y: 0.22 },
      ],
    ...
    'Cloud & Infrastructure': {
      stars: [
        { id: 'azure', name: 'Azure', x: 0.12, y: 0.38 },
        { id: 'docker', name: 'Docker', x: 0.26, y: 0.36 },
        { id: 'kafka', name: 'Kafka', x: 0.40, y: 0.38 },
        { id: 'nginx', name: 'Nginx', x: 0.19, y: 0.48 },
        { id: 'celery', name: 'Celery', x: 0.33, y: 0.50 },
        { id: 'linux', name: 'Linux', x: 0.47, y: 0.48 },
      ],
    ...
    'Tools': {
      stars: [
        { id: 'git', name: 'Git', x: 0.18, y: 0.68 },
        { id: 'gitlab', name: 'GitLab', x: 0.32, y: 0.66 },
        { id: 'postman', name: 'Postman', x: 0.22, y: 0.78 },
        { id: 'socketio', name: 'Socket.IO', x: 0.36, y: 0.80 },
      ],
      connections: [[0, 1], [0, 2], [1, 3], [2, 3]],
    },
  });
